...
userSchema.methods.toSafeObject = function () {
  ...
  delete obj.password;
  // mongoose Map does not serialize through res.json — flatten to a plain object
  if (obj.skillTestResults instanceof Map) {
    obj.skillTestResults = Object.fromEntries(obj.skillTestResults);
  }
  return obj;
};
